...
const BottomDrawer = ({ props, visible, onOk, onSubscribe }) => {
	...
	const completed = stats.storyCounter
		? Math.round((stats.storyCounter / 305) * 100)
		: 0;
	...
	let actions = (
		<View style={{ width: '100%' }}>
			<Title
				...
				keyName='home.bottomDrawer.secondTitle'
			/>
			...
			<View style={styles.actionsRow}>
				...
				<Button
					title='home.bottomDrawer.button.ok'
					onPress={onOk}
					style={styles.button}
				/>
			</View>
			...
			<View style={{ width: '100%' }}>
				...
				<View style={styles.actionsRow}>
					<Body1
						...
						keyName='home.bottomDrawer.dismiss'
						onPress={onOk}
					/>
					<Button
				...
				<View style={styles.card}>
					<View style={styles.container}>
						...
						<Heading5
							...
							keyName='home.bottomDrawer.message'
						/>
