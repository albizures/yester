  ...
  describe('when facebook button is pressed', () => {
    ...
    describe('when something fails', () => {
      it('should show an alert', async () => {
        ...
        LoginManager.logInWithReadPermissions.mockRejectedValueOnce(new Error('some error'))
    ...
    describe('when the login is cancelled', () => {
      it('should show an alert', async () => {
        ...
        LoginManager.logInWithReadPermissions.mockResolvedValue({ isCancelled: true })
